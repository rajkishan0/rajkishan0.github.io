<!DOCTYPE html>
    ...
    <body>
        ...
        <main>
            <section>
                <h1> Welcome, Admin! </h1>
                <p> Here are the Career Applications collected from your website

              <br>


              <br>
              Get the list  by filling the details below </p>

            </section>
            <div class="cen">
            <form method="post" action='CareerGenerate.php'>
                <label for="From" class="txt">From</label>
                <input class= "inp" type="date" id="From" name="From" data-date-format='yyyy-mm-dd'   required min="2010-10-01" max= <?php echo date('Y-m-d'); ?>> <br>
                <label for="To" class="txt2" >To</label>
                <input class= "inp" type="date" id="To" name="To"  data-date-format='yyyy-mm-dd'   required min="2010-10-01" max= <?php echo date('Y-m-d'); ?>><br>
                <label for="type" class="txt3">Choose the query:</label>
                  <select id="subject" name="subject[]" class="dd" >
                      <option value="HR" name="HR" >HR Manager</option>
                      <option value="Photographer" name="Photographer" >Photographer/videographer</option>
                      <option value="Prod" name="Prod" >Production Engineer</option>
                      <option value="Ele" name="Ele">Electric Engineer</option>
                      <option value="Office" name="office">In-Office Intern</option>
                      <option value="Digital" name="Digital">Digital Media Intern</option>
                      <option value="General" name="General" >General Intern</option>
