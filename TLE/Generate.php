    ...
    <body>
        ...
        <main>
            ...
            if($selected=='event'){
              ...
              $query = "SELECT * FROM ClientContact WHERE Time>= '$start_date' AND Time <= '$To_date' AND subject='EVENT Handling'";

            }
            if($selected=='services'){

              $query = "SELECT * FROM ClientContact WHERE Time>= '$start_date' AND Time <= '$To_date' AND subject='Services'";

            }
            if($selected=='partner'){

              $query = "SELECT * FROM ClientContact WHERE Time>= '$start_date' AND Time <= '$To_date' AND subject='Partner'";

            }
            if($selected=='other'){

              $query = "SELECT * FROM ClientContact WHERE Time>= '$start_date' AND Time <= '$To_date' AND subject='none'";

            }
            if($selected=='all'){

              $query = "SELECT * FROM ClientContact WHERE Time>= '$start_date' AND Time <= '$To_date'";
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                $subject =$row['subject'];
                $Message =$row['Message'];
                $user_arr[] = array($ID, $Time, $Name, $EMail,$Number, $subject,$Message);
            ?>
                <tr>
                    <td><?php echo $ID; ?></td>
                    <td><?php echo $Time; ?></td>
